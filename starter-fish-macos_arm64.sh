...
# URLs for tools
NEOVIM_URL="https://github.com/neovim/neovim/releases/download/v0.11.0/nvim-macos-arm64.tar.gz"
...
FZF_URL="https://github.com/junegunn/fzf/releases/download/v0.61.3/fzf-0.61.3-darwin_arm64.tar.gz"
